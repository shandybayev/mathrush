...
// Dependent on Equation_timer.cs, Timer.cs, Equations1.cs, level_controller.cs scripts
...
public class playerMovement : MonoBehaviour {
    ...
    public static bool on_equation;

    Equations1 my_object;
    Equation_timer my_timer;
    Timer timer_end;
    level_controller level2;
    ...
    void Start()
    {
        ...
        my_object = FindObjectOfType<Equations1>();
        my_object.setUp();
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        if (collision.gameObject.name == "finish")
        {
            ...
            if (Equations1.my_score >= 70)
            {
                next_level.SetActive(true);

                level_controller.isOpen2 = true;
                PlayerPrefs.SetInt("open2", level_controller.isOpen2 ? 1 : 0);
            }
            else
                next_level.SetActive(false);
        }
    ...
    {
        timer_end = FindObjectOfType<Timer>();
