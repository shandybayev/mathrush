...
public class playerMovement5 : MonoBehaviour {
    ...
    Equations5 my_object;
    Equation_timer5 my_timer;
    Timer5 timer_end;
    level_controller level5;
    ...
    void Start()
    {
        ...
        my_object = FindObjectOfType<Equations5>();
        my_object.setUp();
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        if (collision.gameObject.name == "finish")
        {
            ...
            if (Equations5.my_score >= 70)
            {
                next_level.SetActive(true);

                level_controller.isOpen6 = true;
                PlayerPrefs.SetInt("open6", level_controller.isOpen6 ? 1 : 0);
            } else
                next_level.SetActive(false);
        }
    ...
    {
        timer_end = FindObjectOfType<Timer5>();
