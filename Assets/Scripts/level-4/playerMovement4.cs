...
public class playerMovement4 : MonoBehaviour {
    ...
    Equations4 my_object;
    Equation_timer4 my_timer;
    Timer4 timer_end;
    level_controller level4;
    ...
    void Start()
    {
        ...
        my_object = FindObjectOfType<Equations4>();
        my_object.setUp();
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        if (collision.gameObject.name == "finish")
        {
            ...
            if (Equations4.my_score >= 70)
            {
                next_level.SetActive(true);

                level_controller.isOpen5 = true;
                PlayerPrefs.SetInt("open5", level_controller.isOpen5 ? 1 : 0);
            } else
                next_level.SetActive(false);
        }
    ...
    {
        timer_end = FindObjectOfType<Timer4>();
