...
public class playerMovement9 : MonoBehaviour {
    ...
    Equations9 my_object;
    Equation_timer9 my_timer;
    Timer9 timer_end;
    level_controller level9;
    ...
    void Start()
    {
        ...
        my_object = FindObjectOfType<Equations9>();
        my_object.setUp();
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        if (collision.gameObject.name == "finish")
        {
            ...
            if (Equations9.my_score >= 70)
            {
                next_level.SetActive(true);

                level_controller.isOpen10 = true;
                PlayerPrefs.SetInt("open10", level_controller.isOpen10 ? 1 : 0);
            } else
                next_level.SetActive(false);
        }
    ...
    {
        timer_end = FindObjectOfType<Timer9>();
