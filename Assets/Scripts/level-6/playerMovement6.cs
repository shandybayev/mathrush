...
public class playerMovement6 : MonoBehaviour {
    ...
    Equations6 my_object;
    Equation_timer6 my_timer;
    Timer6 timer_end;
    level_controller level6;
    ...
    void Start()
    {
        ...
        my_object = FindObjectOfType<Equations6>();
        my_object.setUp();
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        if (collision.gameObject.name == "finish")
        {
            ...
            if (Equations6.my_score >= 70)
            {
                next_level.SetActive(true);

                level_controller.isOpen7 = true;
                PlayerPrefs.SetInt("open7", level_controller.isOpen7 ? 1 : 0);
            } else
                next_level.SetActive(false);
        }
    ...
    {
        timer_end = FindObjectOfType<Timer6>();
