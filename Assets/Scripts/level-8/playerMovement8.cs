...
public class playerMovement8 : MonoBehaviour {
    ...
    Equations8 my_object;
    Equation_timer8 my_timer;
    Timer8 timer_end;
    level_controller level8;
    ...
    void Start()
    {
        ...
        my_object = FindObjectOfType<Equations8>();
        my_object.setUp();
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        if (collision.gameObject.name == "finish")
        {
            ...
            if (Equations8.my_score >= 70)
            {
                next_level.SetActive(true);

                level_controller.isOpen9 = true;
                PlayerPrefs.SetInt("open9", level_controller.isOpen9 ? 1 : 0);
            } else
                next_level.SetActive(false);
        }
    ...
    {
        timer_end = FindObjectOfType<Timer8>();
