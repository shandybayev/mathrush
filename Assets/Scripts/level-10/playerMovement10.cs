// Name: playerMovement10.cs
// Purpose: Allows the player to move
// Version 5, May 31 2021
// Authors: Zhandos Shandybayev, Peter Gallogly, Ryan Anderson
// Dependent on Equation_timer10.cs, Timer10.cs, Equations10.cs, level_controller.cs scripts
...
public class playerMovement10 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        my_object = FindObjectOfType<Equations10>();
        my_object.setUp();
    ...
    {
        timer_end = FindObjectOfType<Timer10>();
